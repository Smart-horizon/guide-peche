export default {
  ...
  fields: [
    ...
    {
      name: 'pageEyebrow',
      title: 'Page — Petit texte au-dessus du titre',
      type: 'string',
      group: 'page',
      initialValue: '📧 Newsletter gratuite',
    },
    {
      name: 'pageCtaHero',
      title: 'Page — Bouton du hero',
      type: 'string',
      group: 'page',
      initialValue: 'S\'inscrire maintenant',
    },
    {
      name: 'pageLead',
      title: 'Page — Phrase d\'intro des 3 blocs',
      type: 'string',
      group: 'page',
      initialValue: 'Chaque lettre contient…',
    },
    {
      name: 'pageCitation',
      title: 'Page — Citation (encadré à droite du formulaire)',
      type: 'text',
      rows: 3,
      group: 'page',
      initialValue: 'J\'essaie de partager dans cette lettre ce que je dis à mes clients sur le terrain. Le genre de détails qui font vraiment la différence.',
      description: 'Affichée entre guillemets — ne pas les saisir',
    },
    {
      name: 'pageCitationAuteur',
      title: 'Page — Signature de la citation',
      type: 'string',
      group: 'page',
    ...
    {
      name: 'pageSucces',
      title: 'Page — Message après inscription',
      type: 'string',
      group: 'page',
      initialValue: 'Inscription confirmée ! À très vite dans votre boîte mail.',
    },
    {
      name: 'pageBasTexte',
      title: 'Page — Texte du bandeau du bas',
      type: 'string',
      group: 'page',
      initialValue: 'Curieux de voir à quoi ça ressemble ?',
    },
    {
      name: 'pageBasLienLabel',
      title: 'Page — Libellé du lien du bandeau du bas',
      type: 'string',
      group: 'page',
      initialValue: 'Lire les derniers articles du blog',
      description: 'Le lien pointe vers le blog',
    },
