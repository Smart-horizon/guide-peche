...
const NON_TEXT_KEY = /^(fond|style|hauteur|alignement|colonnes|position\w*|isLarge|showInfoCard|lien|href|url\w*|video\w*|voyageFeaturedSlug|avatar|emoji|icone|statut|couleur\w*|slug|categorie|badges)$/i
